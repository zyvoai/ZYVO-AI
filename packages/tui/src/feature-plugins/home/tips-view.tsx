...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Zyvo from reading sensitive files",
  "Use {highlight}zyvo run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode --continue{/highlight} to resume the last session",
  "Use {highlight}zyvo run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}zyvo serve{/highlight} for headless API access to Zyvo",
  "Use {highlight}zyvo run --attach{/highlight} to connect to a running server",
  "Run {highlight}zyvo upgrade{/highlight} to update to the latest version",
  "Run {highlight}zyvo auth list{/highlight} to see all configured providers",
  "Run {highlight}opencode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}zyvo github install{/highlight} to set up the GitHub workflow",
  ...
  "Use {highlight}/connect{/highlight} with Zyvo Zen for curated, tested models",
