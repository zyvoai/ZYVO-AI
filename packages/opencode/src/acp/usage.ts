...
import type { AssistantMessage as ZyvoAssistantMessage, Message } from "@opencode-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<ZyvoAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<ZyvoAssistantMessage, "role"> &
  Partial<Pick<ZyvoAssistantMessage, "providerID" | "modelID">>
